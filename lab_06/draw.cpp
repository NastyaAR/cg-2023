...
void draw_point(const int x, const int y, const QColor color, QImage *image)
{
...
void initFigure(figure_t &figure, const lines_t lines, const points_t points, const QColor fill,
				const QColor border, bool isClosed, const figures_t holes, point_t seedPixel)
{
	figure.lines = lines;
